...
CREATE TABLE `micei_system_monitoring` (
  ...
  `refresher_completed_at` datetime DEFAULT NULL,
...
(5, '000005', '2026-05-20', '2026-05-08', 'GLA', NULL, 'Accounting', 'CMIS', 'GERLYN TEJADA', 'OR#279611', '', 'Maria izza saniel samulde', NULL, 'Cancelled due to wrong data entry on amount.', 'RGR', 'Cancellation', 'SA', '', NULL, 'User error', '', '', 'Cancelled', 'Incident report', NULL, NULL, '2026-05-22 01:55:46'),
...
(50, '000050', '2026-06-02', '2026-06-02', 'KID', '', 'CNC', 'AMIS', 'RACHEL PASQUIL', 'GJ#4824', '', '', NULL, 'ADJUSTMENT ON AR BANK FAO CBS FOR SHORT PAYMENTS', '', 'Others', 'SA', '', NULL, 'Others', '', '', 'Done', '', NULL, NULL, '2026-06-26 06:06:48'),
...
(65, '000065', '2026-06-02', '2026-06-02', 'GSC', 'MGSC', 'CNC', 'AMIS', 'RACHEL PASQUIL', '', '', '', NULL, 'ADJUSTMENT ON AR BANK FAO CBS FOR SHORT PAYMENTS', 'NGR', 'Adjustment', 'SA', 'GJ#17285', NULL, 'Others', '', '', '', '', NULL, NULL, '2026-07-01 05:54:28'),
(66, '000066', '2026-06-02', '2026-06-02', 'KID', 'MKC', 'CNC', 'AMIS', 'RACHEL PASQUIL', '', '', '', NULL, 'ADJUSTMENT ON AR BANK FAO CBS FOR SHORT PAYMENTS', 'NGR', 'Adjustment', 'SA', 'GJ#4824', NULL, 'Others', '', '', '', '', NULL, NULL, '2026-07-01 05:55:08'),
...
(2, 'GSC', 'MGSC', 'All Modules', '3854', 'Requesting for inclusion of all accounts in the CDJ Reports Account Detail by Payee.', '2026-05-19', 'SA', 'Resolved', '2026-06-04 16:03:27', '2026-05-23 06:49:45'),
